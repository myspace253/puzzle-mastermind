    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That puzzle piece doesn't fit anywhere.
        </p>
        <div className="mt-6">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Drag, rotate, and solve image puzzles. The faster you think, the higher you climb the leaderboard." },
      { property: "og:title", content: "Piecewise — A Thinking Puzzle Game" },
      { property: "og:description", content: "Drag, rotate, and solve image puzzles across rising difficulty levels." },
